...
python3 /home/vuk/crisw015/UVEX/uvex-followup-etc-update//compute_tiling.py $ALLSKY_SCHED $SKYMAPS_DIR $SCHED_DIR $OUTDIR

echo "Getting statistics and making plots..."
python3 /home/vuk/crisw015/UVEX/uvex-followup-etc-update//make-coverage-plots.py $ALLSKY_FILE $ALLSKY_COV $OUTDIR $BAND $MAG $RATE_ADJ
